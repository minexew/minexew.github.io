...
As for the tools, I expect to use [radare](https://rada.re/) heavily, along with the RetDec decompiler.
...
- What did pokeruby do? Can't find anything ARM-related in their tools repo. https://github.com/LanHikari22/GBA-IDA-Pseudo-Terminal might be relevant.
